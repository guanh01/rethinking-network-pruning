...
import data_wikitext.data as data 
import model
import distiller
...
parser.add_argument('--data', type=str, default='./data_wikitext/data/wikitext-2',
...
base_path = "/home/hguan2/workspace/fault-tolerance/rethinking-network-pruning/cifar/l1-norm-pruning/logs/lstm/"
args.resume = os.path.join(base_path, 'checkpoint.pth.tar.best')
args.save = os.path.join(base_path, "wot", 'checkpoint.pth.tar')
...
#     source = args.compress
    source = "/home/hguan2/workspace/fault-tolerance/rethinking-network-pruning/cifar/l1-norm-pruning/quant_aware_training.yaml"
